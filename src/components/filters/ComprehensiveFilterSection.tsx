...
export const ComprehensiveFilterSection: React.FC<ComprehensiveFilterSectionProps> = React.memo(({
  availableLocations,
  availableCategories = [],
  availableProducts = [],
  availableSoldBy = [],
...
ComprehensiveFilterSection.displayName = 'ComprehensiveFilterSection';
