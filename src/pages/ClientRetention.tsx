...
import { ReconstructedClientConversionMetrics } from '@/components/dashboard/ReconstructedClientConversionMetrics';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-pink-50/20">
      ...
      <div className="container mx-auto px-6 py-8">
        <main className="space-y-8">
          {/* Location Selector - Now prominently displayed */}
          ...
          {/* Enhanced Filter Section with improved date picker */}
